...
const Weather = ({ weatherData }) => {
  return (
    <div>
      {weatherData.weather ? (
        <div className="w-[500px] h-[250px] bg-gray-300 shadow-lg rounded-xl m-auto px-6 top-[10%]">
          <div className="flex justify-between w-full">
            <div className="w-1/2 flex mx-auto my-4 justify-between items-center">
        ...
        <div className="relative">
            <img className="w-[120px]" src={`http://openweathermap.org/img/wn/${weatherData.weather[0].icon}@2x.png`} alt="" />
